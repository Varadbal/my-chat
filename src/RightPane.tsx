...
}>
{
    ...
    {
        //TODO CHECK
        let neptunFirst : string = "Q";

        proxy.sendPacket({type:"message", channelId: this.props.conversation!.channelId, referenceTo: 0, contentType: 0, content: neptunFirst.concat(text)});
        return true;
    }
}